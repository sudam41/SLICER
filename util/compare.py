...
df10 = pd.read_csv('10/ttf.csv', sep=',',index_col=0)
df3 = pd.read_csv('3/ttf.csv', sep=',',index_col=0)
df2 = pd.read_csv('2/ttf.csv', sep=',',index_col=0)

TTF0 = np.array(df3['TTF2'])

TTF1 = np.array(df2['TTF1'])
TTF2 = np.array(df2['TTF0'])

TTF3 = np.array(df3['TTF1'])

TTF4 = np.array(df10['TTF1'])
TTF5 = np.array(df10['TTF2'])
TTF6 = np.array(df10['TTF3'])
TTF7 = np.array(df10['TTF4'])
TTF8 = np.array(df10['TTF5'])
TTF9 = np.array(df10['TTF6'])
TTF10 = np.array(df10['TTF7'])
TTF11 = np.array(df10['TTF8'])
TTF12 = np.array(df10['TTF9'])
