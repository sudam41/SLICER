...
void OneSource_67() {
	FOR(uint32_t, __iter_steady_, 0, <, 2, __iter_steady_++)
		OneSource(&(OneSource_67WEIGHTED_ROUND_ROBIN_Splitter_76));
	ENDFOR
}
...
void Identity_70() {
	Identity(&(SplitJoin0_SplitJoin0_SplitJoin0_AnonFilter_a0_69_80_90_93_split[0]), &(SplitJoin0_SplitJoin0_SplitJoin0_AnonFilter_a0_69_80_90_93_join[0]));
}
...
void Multiply_71() {
	Multiply(&(SplitJoin0_SplitJoin0_SplitJoin0_AnonFilter_a0_69_80_90_93_split[1]), &(SplitJoin0_SplitJoin0_SplitJoin0_AnonFilter_a0_69_80_90_93_join[1]));
}
...
void Add_73() {
	Add(&(SplitJoin2_SplitJoin2_SplitJoin2_AnonFilter_a1_72_82_91_94_split[0]), &(SplitJoin2_SplitJoin2_SplitJoin2_AnonFilter_a1_72_82_91_94_join[0]));
}
...
void Subtract_74() {
	Subtract(&(SplitJoin2_SplitJoin2_SplitJoin2_AnonFilter_a1_72_82_91_94_split[1]), &(SplitJoin2_SplitJoin2_SplitJoin2_AnonFilter_a1_72_82_91_94_join[1]));
}
...
void FloatPrinter_75() {
	FOR(uint32_t, __iter_steady_, 0, <, 2, __iter_steady_++)
		FloatPrinter(&(WEIGHTED_ROUND_ROBIN_Joiner_79FloatPrinter_75));
	ENDFOR
}
