...
df = pd.DataFrame(data=np.array(avetemp))
df.to_csv("./avetemp_1ghz.csv")

df = pd.DataFrame(data=np.array(sttemp))
df.to_csv("./stdtemp_1ghz.csv")
...
#       ecolor='black',
#       color='grey',
#       capsize=10,label= 'Core 5 - Disabled')
...
#       ecolor='black',
#       color='grey',
#       capsize=10,label= 'Core 6 - Disabled')
