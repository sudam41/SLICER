...
data0 = pd.read_csv('ttf_1.csv', sep=",")
data1 = pd.read_csv('ttf_2.csv', sep=",")
data2 = pd.read_csv('ttf_3.csv', sep=",")
data3 = pd.read_csv('ttf_4.csv', sep=",")


#print(np.array(data1.iloc[:,1]))
...
MTTF = [np.average(ttf0),np.average(ttf1),np.average(ttf2),np.average(ttf3)]
SD = [np.std(ttf0),np.std(ttf1),np.std(ttf2),np.std(ttf3)]
#print("tff:",len(ttf0))
...
ax.set_title('MTTF with respect to the frequency')
ax.yaxis.grid(True)
